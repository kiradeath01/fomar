...
<html lang="en">
  ...
  <!--<div class="loader"></div>-->
    ...
    <div class="container-fluid bg-body">
      ...
      <div class="m-2">
        <img src="img/MINI/MINI3.PNG" class="d-block w-100" alt="...">
      </div>
      <div class="m-2">
        <img src="img/MINI/MINI4.PNG" class="d-block w-100" alt="...">
      </div>
      <div class="row m-2">
        <div class="col-md-6">
          <img src="img/MINI/MINI5.PNG" class="d-block w-100" alt="...">
        </div>
        <div class="col-md-6">
