          ...
          '<div class="container-fluid imf">'+
            ...
            '<div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">'+
              '<div class="navbar-nav">'+
                ...
                '<a class="nav-link text-white" href="#">Fogón Leña  </a> <span class="lvert"></span>'+
                '<a class="nav-link text-white" href="#">Fogón Hibrido</a> <span class="lvert"></span>'+
                '<a class="nav-link text-white" href="#">Fogón Hibrido Plus</a> <span class="lvert"></span>'+
                '<a class="nav-link text-white" href="#">Fogón Estufa Small</a> <span class="lvert"></span>'+
